...
$.get(
    "https://9a2374a7-f18c-4c4e-aaa7-576c4e20a684.mock.pstmn.io/more-cupcakes",
    function (data) {
        console.log(data);
    ...
    $("#cupcakes")
        .empty()
        .append("<div>There was an error in your request</div>");
});
    ...
    if (cupcakesCollection[0].name == "Bubble Gum Pop") {
        ...
        $.ajax({
            ...
            .fail(function () {
                $("#cupcakes").empty();
                $("#cupcakes").append(
                    "<div>There was an error while trying to contact the server</div>"
                );
            });
    }
});
